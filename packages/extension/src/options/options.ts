...
const extensionIdSpan = document.getElementById('extension-id') as HTMLSpanElement;
 ...
 */
function setActiveButton(type: 'ai' | 'serp', providerId: string, shouldSave = true): void {
